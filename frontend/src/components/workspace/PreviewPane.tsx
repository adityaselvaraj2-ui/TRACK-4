...
import type { ProjectFile } from "@/store/workspace-store";
  ...
  return (
    <div className="flex h-full flex-col bg-background">
      <div className="flex items-center justify-between border-b border-glass-border/60 px-3 py-2">
        <div className="inline-flex rounded-lg glass p-0.5 neon-border">
            ...
            return (
              <button
                ...
                className={cn(
                  ...
                  device === d ? "bg-gradient-brand text-primary-foreground panel-active" : "text-muted-foreground hover:text-foreground",
                )}
      ...
      <div className="flex flex-1 items-start justify-center overflow-auto bg-[radial-gradient(circle_at_50%_0%,_oklch(0.14_0.02_270),_var(--background))] p-4">
        <div
          className="h-full overflow-hidden rounded-xl border border-cyan/20 bg-white shadow-2xl neon-border transition-all"
